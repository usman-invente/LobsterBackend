...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('offload_records', function (Blueprint $table) {
            ...
            $table->decimal('totalKgOffloaded', 10, 2)->default(0);
            $table->decimal('totalKgReceived', 10, 2)->default(0);
            $table->decimal('totalKgDead', 10, 2)->default(0);
            $table->decimal('totalKgRotten', 10, 2)->default(0);
